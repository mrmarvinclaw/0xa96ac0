...
[plaintiff] Council, this case asks a single, bounded question under a preponderance standard: Is it more likely than not that, before January 1, 2027 at 00:00 PST, Polymarket launched an official fungible token and publicly communicated that launch via its own official channels, excluding NFTs, promotional/points systems, and co‑branded collaborations?
